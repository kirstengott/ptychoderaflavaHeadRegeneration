---
title: "*Ptychodera flava* Head Regeneration Experiment"
...
pheatmap(p.t, color = prettycolors, breaks = col.breaks, 
         ...
         fontsize=8, filename="rendered_figures/upregulated_heatmap.png")
...
lapply(clusters, function(x){
    ...
    pheatmap(df.edit, color = prettycolors, breaks = col.breaks, 
             ...
             filename = paste0("rendered_figures/up_", file.name, "_heatmap.png"))
})
...
pheatmap(p.t, color = prettycolors, breaks = col.breaks, 
         ...
         cellwidth = cell.width, cellheight= 10, border_color=NA,
         annotation_row=annotation, annotation_colors = ann.cols, 
         fontsize=8, filename="rendered_figures/downregulated_heatmap.png")
...
lapply(clusters, function(x){
    ...
    pheatmap(df.edit, color = prettycolors, breaks = col.breaks, 
             ...
             main = paste0(x, ": ", nrow(df.edit)," Genes"), 
             cellwidth = cell.width,  cellheight=10, border_color=NA,
             fontsize=8, height = new.height, filename = paste0("rendered_figures/down_", file.name, "_heatmap.png"))
})
...
#Links to Large figures created in code chunks

[down_ClusterA_heatmap](rendered_figures/down_ClusterA_heatmap.png)

[down_ClusterB_heatmap](rendered_figures/down_ClusterB_heatmap.png)

[down_ClusterC_heatmap](rendered_figures/down_ClusterC_heatmap.png)

[down_ClusterD_heatmap](rendered_figures/down_ClusterD_heatmap.png)

[downregulated_heatmap](rendered_figures/downregulated_heatmap.png)

[up_ClusterA_heatmap](rendered_figures/up_ClusterA_heatmap.png)

[up_ClusterB_heatmap](rendered_figures/up_ClusterB_heatmap.png)

[up_ClusterC_heatmap](rendered_figures/up_ClusterC_heatmap.png)

[up_ClusterD_heatmap](rendered_figures/up_ClusterD_heatmap.png)

[upregulated_heatmap](rendered_figures/upregulated_heatmap.png)
